              ...
              <div class="row">
                <div class="col-sm-12 col-md-6">
                  <ul class="list-inline">
                      <li class="list-inline-item"><a href="{{ url('/business-partner/create') }}" role="button" class="btn btn-primary">New Business Partner</a></li>
                  </ul>
                </div>
                <div class="col-sm-12 col-md-6">
                  @include('billings.businesspartner.searchform')
                </div>
              </div>
            </div>
